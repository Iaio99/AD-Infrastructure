...
build {
  ...
  provisioner "shell" {
    inline  = [
      ...
      "apt-get install -y sudo python-is-python3 python3 cron vim tcpdump tmux bash-completion openssh-server nano file utils-linux openssh-sftp-server htop ncdu",
